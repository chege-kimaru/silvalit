<?php
    ...
    $product_images = getProductImages($_GET['product_id']);
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3><?php print $product['name']; ?> </span></h3>
			<!--/w3_short-->
...
<div class="banner-bootom-w3-agileits">
	<div class="container">
			...
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						...
						<li data-thumb="<?php print $product_image['image']; ?>">
							<div class="thumb-image"> <img src="<?php print $product_image['image']; ?>" data-imagezoom="true" class="img-responsive"> </div>
						</li>
                        <?php endforeach; ?>
					</ul>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<p><span class="item_price">KSH <?php print $product['price']; ?></span> <del>- $900</del></p>
					<div class="rating1">
					...
					<!--/tab_one-->
					   <div class="tab1">
							...
							<div class="single_page_agile_its_w3ls">
							  <h6><?php print $product['description']; ?></h6>
							   <p> </p>
							   <p class="w3ls_para"> </p>
							</div>
						</div>
